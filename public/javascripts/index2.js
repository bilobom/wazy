...
/*
     ...
     function onGettingWebRTCStats(stats, remoteUserId) {
       ...
       statsData += 'Bandwidth: ' + bytesToSize(stats.bandwidth.speed)+'/s';
       statsData += '\n';
     ...
     //shre files
      /*  document.getElementById('share-file').onclick = function() {
        ...
        //alert("Soket open , UserId --> "+$('input#userID').val());
